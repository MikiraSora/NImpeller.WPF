...
public static class GalleryScenes
{
    public static IReadOnlyList<IGalleryScene> All { get; } = new IGalleryScene[]
    {
        ...
        new ClippingScene(),
        new SaveLayerScene(),
        new OffscreenCompositeScene(),
        new DisplayListBuilderNewScene(),
        new DrawDisplayListScene(),
        new DrawTextureRectScene(),
        new DrawTextureScene(),
        new MaskBlurScene(),
